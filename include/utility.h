...
public:
    ...
    float gpuLocalMapSurfVoxelSize;
    float gpuLocalMapCornVoxelSize;
    int   gpuLocalMapSurfMOD;
    int   gpuLocalMapCornMOD;
    int   gpuLocalMapSurfReductionFactorNRTR;
    int   gpuLocalMapSurfReductionFactorDNTR;
    int   gpuLocalMapCornReductionFactorNRTR;
    int   gpuLocalMapCornReductionFactorDNTR;
    ...
    ParamServer()
    {
        ...
        nh.param<float>( "lio_sam/gpuLocalMapSurfVoxelSize"                , gpuLocalMapSurfVoxelSize                , 0.5    );
        nh.param<float>( "lio_sam/gpuLocalMapCornVoxelSize"                , gpuLocalMapCornVoxelSize                , 0.5    );
        nh.param<int  >( "lio_sam/gpuLocalMapSurfMOD"                      , gpuLocalMapSurfMOD                      , 100000 );
        nh.param<int  >( "lio_sam/gpuLocalMapCornMOD"                      , gpuLocalMapCornMOD                      , 100000 );
        nh.param<int  >( "lio_sam/gpuLocalMapSurfReductionFactorNRTR"      , gpuLocalMapSurfReductionFactorNRTR      , 1      );
        nh.param<int  >( "lio_sam/gpuLocalMapSurfReductionFactorDNTR"      , gpuLocalMapSurfReductionFactorDNTR      , 8      );
        nh.param<int  >( "lio_sam/gpuLocalMapCornReductionFactorNRTR"      , gpuLocalMapCornReductionFactorNRTR      , 1      );
        nh.param<int  >( "lio_sam/gpuLocalMapCornReductionFactorDNTR"      , gpuLocalMapCornReductionFactorDNTR      , 8      );
