...
#ifndef LIO_SAM_CUDA_CALC_CORN_COEFF_CUH
#define LIO_SAM_CUDA_CALC_CORN_COEFF_CUH
...
struct CalcCornCoeffKernel {
public :
    CalcCornCoeffKernel() { cudaStreamCreateWithFlags(&cuda_stream, cudaStreamNonBlocking); }
    ~CalcCornCoeffKernel() { Sync(); cudaStreamDestroy(cuda_stream); }
