...
#include "./col_piv_householder_qr_v3.cuh"
...
__global__ void _CalcSurfCoeffKernel(
    ...
    ColPivHouseholderQRNx3<5> qr_decomp(matA0, i);
    ...
    //     "\t%.10f , %.10f , %.10f \n",
    //     i, 
    //     matA0(0, 0), matA0(0, 1), matA0(0, 2), 
    //     matA0(1, 0), matA0(1, 1), matA0(1, 2), 
    //     matA0(2, 0), matA0(2, 1), matA0(2, 2), 
    //     matA0(3, 0), matA0(3, 1), matA0(3, 2), 
    //     matA0(4, 0), matA0(4, 1), matA0(4, 2)
    // );
    ...
    float s = 1.0 - 0.9 * fabs(pd2) / sqrt(sqrt(powf(point_sel.x, 2) + powf(point_sel.y, 2) + powf(point_sel.z, 2)));
